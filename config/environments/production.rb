...
Rails.application.configure do
  ...
  # Host for URL helpers (e.g. auth callback). Render sets RENDER_EXTERNAL_URL.
  default_host = ENV['RENDER_EXTERNAL_URL'].then { |u| u ? URI(u).host : nil } || 'algo-trading-api.onrender.com'
